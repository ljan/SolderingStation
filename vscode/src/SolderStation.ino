...
#define ST7735_GREY 0x632C //Missing color in TFT lib
...
void setup(void) {
	...
	#ifdef RESET
	delay(300); //Display resetten um Funktion zu gewährleisten
	pinMode(rst, OUTPUT);
	...
	//Print station Logo
  	tft.drawBitmap(33,0,stationLOGO1,124,47,ST7735_GREY);
	tft.drawBitmap(34,2,stationLOGO1,124,47,ST7735_YELLOW);		
	tft.drawBitmap(34,2,stationLOGO2,124,47,Color565(254,147,52));	
	tft.drawBitmap(34,2,stationLOGO3,124,47,Color565(255,78,0));
	...
	tft.setTextSize(1);
	tft.setTextColor(ST7735_GREY);
	tft.setCursor(130,0);	// 103,0
	tft.print("v");
	tft.print(VERSION);
	
	tft.setTextColor(ST7735_YELLOW);
	tft.setCursor(131,1);	// 104,1
	tft.print("v");
	tft.print(VERSION);
	...
	tft.setTextSize(1);
	tft.setCursor(1,80);	// 1,84
	tft.print("ist");
	
	tft.setTextSize(2);
	tft.setCursor(117,43);	// 117,47
	tft.print("o");
	
	tft.setTextSize(1);
	tft.setCursor(1,119);	// 1,129
	tft.print("soll");
	
	tft.setTextSize(2);
	tft.setCursor(117,82);	// 117,92
	tft.print("o");
	
	//tft.setCursor(0,53);	// 80,144
	//tft.print("   %");
	
	tft.setTextSize(1);
	tft.setCursor(124,78);	// 1,151
	tft.print(" pwm %");
